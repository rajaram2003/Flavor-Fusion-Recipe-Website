    ...
    <div className='w-full h-[100vh]'>
      ...
      <div className='absolute w-full h-full bg-gradient-to-t from-black to-transparent top-0 z-8 flex flex-col items-center justify-center pt-40 2xl:pt-20 px-4'>
        ...
        <h1 className='text-white text-4xl md:text-5xl font-bold text-center'>
          ...
          {
          type && (
            <p className='text-sm mt-4 text-center text-green-500 bg-[#00000090] px-6 py-4 rounded-full '>Welcome to FlavorFusion: Ignite Your Passion for Cooking!
              <br className='hidden md:block' /> Delve into a world of delectable recipes from everywhere.</p>
          )
        }
